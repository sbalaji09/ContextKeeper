...
function serializeControl(el) {
  ...
  if (el.isContentEditable) {
    ...
    base.value = el.innerText; // Using innerText instead of innerHTML for security
  }
...
// builds the final payload for the window - this value is returned to executeScript
({
